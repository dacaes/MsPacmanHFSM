...
public class StateDefensive extends State
{
	private MachineDefensive myMachineDefensive;
	...
	{
		myMachineDefensive.update(myMoves, ghost, game);
		
		return myMoves;
	}
	
	public StateDefensive()
	{	
		myMachineDefensive = new MachineDefensive();
	}
}
